...
configs =[
    {"lr": 1e-4,    "gamma": 0.96,  "batch": 32,  "eps_start": 1.0, "eps_end": 0.05, "eps_decay": 0.25},
    {"lr": 4e-5,    "gamma": 0.999, "batch": 8,   "eps_start": 1.0, "eps_end": 0.01, "eps_decay": 0.1},
    {"lr": 1.8e-4,  "gamma": 0.99,  "batch": 64,  "eps_start": 1.0, "eps_end": 0.03, "eps_decay": 0.4},
    {"lr": 3e-5,    "gamma": 0.97,  "batch": 128, "eps_start": 1.0, "eps_end": 0.05, "eps_decay": 0.15},
    {"lr": 2.2e-4,  "gamma": 0.95,  "batch": 16,  "eps_start": 1.0, "eps_end": 0.005,"eps_decay": 0.2},
    {"lr": 5e-5,    "gamma": 0.98,  "batch": 32,  "eps_start": 1.0, "eps_end": 0.02, "eps_decay": 0.3},
    {"lr": 1.1e-4,  "gamma": 0.995, "batch": 64,  "eps_start": 1.0, "eps_end": 0.04, "eps_decay": 0.12},
    {"lr": 2e-5,    "gamma": 0.999, "batch": 16,  "eps_start": 1.0, "eps_end": 0.01, "eps_decay": 0.25},
    {"lr": 1.3e-4,  "gamma": 0.985, "batch": 128, "eps_start": 1.0, "eps_end": 0.03, "eps_decay": 0.1},
    {"lr": 6e-5,    "gamma": 0.975, "batch": 8,   "eps_start": 1.0, "eps_end": 0.1,  "eps_decay": 0.4},
]
