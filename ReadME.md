[Nhial_exp - idiot i gave you example of how the table should... (1).tsv](https://github.com/user-attachments/files/23588315/Nhial_exp.-.idiot.i.gave.you.example.of.how.the.table.should.1.tsv)```markdown
